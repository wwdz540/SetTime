...
public class FirstWeatherFragment extends Fragment {
	...
	public void updateWeather(WeatherInfo weatherinfo) {
		...
		if (weatherinfo != null) {
			weather_imgIv1.setImageResource(BaseApplication.getInstance()
					.getWeatherIcon(weatherinfo.getWeather1()));
			weather_imgIv2.setImageResource(BaseApplication.getInstance()
					.getWeatherIcon(weatherinfo.getWeather2()));
			weather_imgIv3.setImageResource(BaseApplication.getInstance()
